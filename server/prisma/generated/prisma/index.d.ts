...
export namespace Prisma {
  ...
  */
  ...
  export type AuditOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "nanoid" | "tool" | "plan" | "teamSize" | "useCase" | "monthlyCost" | "recommendation" | "savings" | "summary" | "createdAt", ExtArgs["result"]["audit"]>
  ...
  interface AuditFieldRefs {
    ...
    readonly nanoid: FieldRef<"Audit", 'String'>
    readonly tool: FieldRef<"Audit", 'String'>
    readonly plan: FieldRef<"Audit", 'String'>
    readonly teamSize: FieldRef<"Audit", 'Int'>
    readonly useCase: FieldRef<"Audit", 'String'>
    readonly monthlyCost: FieldRef<"Audit", 'Float'>
    readonly recommendation: FieldRef<"Audit", 'String'>
    readonly savings: FieldRef<"Audit", 'Float'>
  ...
  export type AuditWhereInput = {
    ...
    nanoid?: StringFilter<"Audit"> | string
    tool?: StringFilter<"Audit"> | string
    plan?: StringFilter<"Audit"> | string
    teamSize?: IntFilter<"Audit"> | number
    useCase?: StringFilter<"Audit"> | string
    monthlyCost?: FloatFilter<"Audit"> | number
    recommendation?: StringFilter<"Audit"> | string
    savings?: FloatFilter<"Audit"> | number
    summary?: StringFilter<"Audit"> | string
  ...
  export type AuditScalarWhereWithAggregatesInput = {
    ...
    nanoid?: StringWithAggregatesFilter<"Audit"> | string
    tool?: StringWithAggregatesFilter<"Audit"> | string
    plan?: StringWithAggregatesFilter<"Audit"> | string
    teamSize?: IntWithAggregatesFilter<"Audit"> | number
    useCase?: StringWithAggregatesFilter<"Audit"> | string
    monthlyCost?: FloatWithAggregatesFilter<"Audit"> | number
    recommendation?: StringWithAggregatesFilter<"Audit"> | string
    savings?: FloatWithAggregatesFilter<"Audit"> | number
    summary?: StringWithAggregatesFilter<"Audit"> | string
